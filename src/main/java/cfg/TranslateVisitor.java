...
public class TranslateVisitor implements codegen.C.Visitor
{
  ...
  public TranslateVisitor()
  {
    ...
    this.type = null;
    this.dec = null;
    this.stmOrTransfer = new ArrayList<>();
  ...
  {
    LinkedList<Ftuple> newTuples = new LinkedList<>();
    for (codegen.C.Ftuple t : v.ms) {
      ...
      newTuples.add(new Ftuple(t.classs, ret, args, t.id));
    }
    this.vtable = new VtableSingle(v.cname, newTuples);
  }
  ...
  public void visit(codegen.C.Ast.Class.ClassSingle c)
  {
    ...
    for (codegen.C.Tuple t : c.decs) {
      t.type.accept(this);
      newTuples.add(new Tuple(t.classs, this.type, t.id));
    }
